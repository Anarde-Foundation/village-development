...
urlpatterns = [
    ...
    path('survey_suggestion', views.survey_domain_suggestion, name='survey_suggestion'),
    path('survey_program_list/<int:pk>', views.survey_program_list, name='survey_program_list'),
    path('survey_program_list/survey_location_program_update/<int:pk>', views.location_program_update, name='survey_location_program_update'),
    path('get_location_program_list_for_datatable/<int:pk>', views.get_location_program_list_for_datatable,
