...
GROUP 	BY SQ.survey_id , SQ.survey_question_id , SQ.question_label , SQ.question_name, SQ.question_label,SQ.domain_id
...
GROUP 	BY SQ.survey_id , SQ.survey_question_id , SQ.question_label , SQ.question_name, QO.option_label,
        QO.survey_question_options_id, SQ.domain_id
